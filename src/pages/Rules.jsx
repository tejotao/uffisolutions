...
const Rules = () => {
  ...
  const content = getTranslationObject('legal.rules_content') || [];
  ...
  return (
    <>
      <Helmet>
        <title>{t('legal.rules_title')} - UffiSolutions</title>
      </Helmet>
      <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white flex flex-col transition-colors duration-300">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight text-gray-900 dark:text-white">{t('legal.rules_title')}</h1>
